    ...
    public static class PatchManager
    {
        ...
        public static MethodBase readMethod(BinaryReader reader, Type[] externTypes)
        {
                    ...
                    if (paramMatch)
                    {
                        for (int j = 0; j < paramCount; j++)
                        {
                            ...
                            if (strMatchInfo != null)
                            {
                                ...
                                {
                                    //Debug.Log("gp not match:" + strMatchInfo + " ??? "
                            ...
                            else
                            {
                                ...
                                {
                                    //Debug.Log("pt not match:" + paramMatchInfo[j] + " ??? "
            ...
            else
            {
                ...
                string methodName = reader.ReadString();
                int paramCount = reader.ReadInt32();
                //Debug.Log("load no generic method: " + declaringType + " ?? " + methodName + " pc "
                //    + paramCount);
            ...
            using (BinaryReader reader = new BinaryReader(stream))
            {
                ...
                for (int j = 0; j < methodCount; j++)
                {
                    ...
                    for (int i = 0; i < codeSize; i++)
                    {
                        ...
                        //Debug.Log(i + " Code=" + unmanagedCode[i].Code + " Operand="
