...
namespace IFix.Core
{
    ...
    unsafe public class VirtualMachine
    {
        ...
        {
            Debug.Log(title + ", t=" + val->Type + ", v=" + val->Value1);
        }
            ...
            int refCount = 0, Value** topWriteBack = null)
        {
            ...
            //Debug.Log("localsCount:" + localsCount + ",maxStack:" + maxStack + ", argumentBase:"
            //    + (long)argumentBase);
                        ...
                        case Code.Call:// Call: 8.1233%
                            {
                                ...
                                //Debug.Log("narg:" + narg);
                                //Debug.Log("before call ESP = " + (evaluationStackPointer - localBase
                                ...
                                evaluationStackPointer = Execute(unmanagedCodes[methodIndexToCall],
                                    ...
                                    methodIndexToCall);
                                //Debug.Log("after call ESP = " + (evaluationStackPointer - localBase
                                //    - localsCount));
                                    ...
                                    case ValueType.StackReference:
                                        {
                                            ...
                                            *des = *src;
                                            ...
                                            //Debug.Log("store to stack address:" + new IntPtr(des) 
                        ...
                        case Code.Switch://0.04518777%
                            {
                                ...
                                if (val >= 0 && val < pc->Operand)
                                {
                                    ...
                                    //Debug.Log("val:" + val + ", jmp to:" + jmpTable[val]);
                                    pc += jmpTable[val];
                                }
                                else
                                {
