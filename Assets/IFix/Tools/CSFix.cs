...
namespace IFix
{
    public static class Tools
    {
        ...
        {
            Debug.Log("Usage:");
            Debug.Log("IFix -inject core_assmbly_path assmbly_path config_path patch_file_output_path"
                + " injected_assmbly_output_path [search_path1, search_path2 ...]");
            Debug.Log("IFix -inherit_inject core_assmbly_path assmbly_path config_path "
                + "patch_file_output_path injected_assmbly_output_path inherit_assmbly_path "
                + "[search_path1, search_path2 ...]");
            Debug.Log("IFix -patch core_assmbly_path assmbly_path injected_assmbly_path"
