...
namespace IFix.Editor
{
    ...
    {
        public const string IFixCoreDllPath = "Library/ScriptAssemblies/IFix.Core.dll";
        //备份目录
        ...
        public static void CallIFix(List<string> args)
        {
            ...
            UnityEngine.Debug.Log($"#ifix args:[{string.Join("\n", args)}]");
            BuildTargetGroup bg = EditorUserBuildSettings.selectedBuildTargetGroup;//BuildTargetGroup.Android;
            UnityEngine.Debug.Log("DefineSymbols: " + PlayerSettings.GetScriptingDefineSymbolsForGroup(bg));
            IFix.Tools.Main(args.ToArray());
...
//
//             StringBuilder fixedList = new StringBuilder(1024);
//             UnityEngine.Debug.Log($"#ifix args:[{string.Join("\n", args)}]");
//             BuildTargetGroup bg = EditorUserBuildSettings.selectedBuildTargetGroup;//BuildTargetGroup.Android;
//             UnityEngine.Debug.Log("DefineSymbols: " + PlayerSettings.GetScriptingDefineSymbolsForGroup(bg));
...
//             }
        ...
        public static void AutoInjectAssemblys()
        {
            ...
            {
                InjectAllAssemblys();
                Debug.Log("<color=green>IFix AutoInjectAssemblys done</color>");
                if (InjectOnce)
                {
                    injected = true;
                }
        ...
        public static void InjectAssembly(string assembly)
        {
            ...
            if (hasSomethingToDo)
            {
                ...
                var core_path = IFixCoreDllPath;
                var assembly_path = string.Format("./Library/ScriptAssemblies/{0}.dll", assembly);
                var patch_path = string.Format("./{0}.ill.ifix", assembly);
        ...
        public static void InjectAllAssemblys()
        {
            ...
            foreach (var assembly in injectAssemblys)
            {
                ...
                UnityEngine.Debug.LogFormat("inject:{0}", assembly);
            }
