...
function test.Awake()
	...
	self.Insertxy_Button.onClick:AddListener(function (  )
		self.InsertOnClick()
	end)

	self.Insert_10000_Button.onClick:AddListener(function (  )
		self.Insert_10000_Button.interactable = false
		assert(coroutine.resume(test.coroutine_insert_10000()))
	end)
	
	self.OpenOP_Button.onClick:AddListener(function (  )
	...
	self.ix_InputField.onEndEdit:AddListener(function ( text )
		self.iy_InputField:Select()
		print("x_InputField.onEndEdit:"..text)
	end)
	self.iy_InputField.onEndEdit:AddListener(function ( text )
