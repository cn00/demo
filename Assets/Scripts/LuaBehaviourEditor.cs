    ...
    public class LuaBehaviourEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            #region Injections
            {
                ...
                {
                    mTarget.Injections = new List<LuaBehaviour.Injection>();
                }
                ...
                if(mTarget.Injections.Count != size)
                {
                    ...
                    {
                        mTarget.Injections.Add(new LuaBehaviour.Injection());
                    }
                    if (mTarget.Injections.Count > size)
                    {
                ...
                if (mShowInjections)
                {
                    ...
                    {
                        var item = mTarget.Injections[i] ?? new LuaBehaviour.Injection();
                        EditorGUILayout.BeginHorizontal();
                        {
            ...
            #region InjectValues
            {
                ...
                {
                    mTarget.InjectValues = new List<LuaBehaviour.InjectValue>();
                }
                ...
                if(mTarget.InjectValues.Count != size)
                {
                    ...
                    {
                        mTarget.InjectValues.Add(new LuaBehaviour.InjectValue());
                    }
                    if (mTarget.InjectValues.Count > size)
                    {
                ...
                if (mShowInjectionValues)
                {
                    ...
                    {
                        var item = mTarget.InjectValues[i] ?? new LuaBehaviour.InjectValue();
                        EditorGUILayout.BeginHorizontal();
                        {
