...
local function update(self, pos, newValue)
...
--- end
local function peekValueU(self)
    return self.values[1]
end
...
local function valueByPayload(self, payload)
