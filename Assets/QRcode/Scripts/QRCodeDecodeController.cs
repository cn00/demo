...
using QRScanFinished = System.Action<string>; //declare a delegate to deal with the QRcode decode complete
...
public class QRCodeDecodeController : MonoBehaviour
{
    ...
    public event Action<string> onQRScanFinished;       //declare a event with the delegate to trigger the complete event
