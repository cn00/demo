    ...
    public class UnityEngineScreenCaptureWrap 
    {
        ...
        static int _m_CaptureScreenshotAsTexture_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    int superSize = LuaAPI.xlua_tointeger(L, 1);
                    
                        UnityEngine.Texture2D __cl_gen_ret = UnityEngine.ScreenCapture.CaptureScreenshotAsTexture( superSize );
                ...
                if(__gen_param_count == 0) 
                {
                        ...
                        UnityEngine.Texture2D __cl_gen_ret = UnityEngine.ScreenCapture.CaptureScreenshotAsTexture(  );
                        translator.Push(L, __cl_gen_ret);
