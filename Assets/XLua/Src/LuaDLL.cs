...
namespace XLua.LuaDLL
{
    ...
    public partial class Lua
	{
		...
		public const string LUADLL  = "lua"; // ok
		...
		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern LuaTypes lua_getglobal(IntPtr L, string key);

		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern LuaTypes lua_getfield(IntPtr L, int index, string key);
        ...
        [DllImport(DLL_I64LIB, CallingConvention = CallingConvention.Cdecl)]
